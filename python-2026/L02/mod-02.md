...
# 🔷 MODULO Pandas / NumPy → Dataset Kaggle

## Dataset consigliati (testati in aula)
...
### Groupby serio (non banale)

```python
df.groupby(["Pclass", "Sex"])["Survived"].mean()
```

### Feature engineering (vectorization vs apply)
...
## Punto didattico chiave (che spesso manca)
...
# NumPy equivalente (più basso livello)
import numpy as np
